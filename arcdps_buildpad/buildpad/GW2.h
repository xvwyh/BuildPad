...
struct GW2
{
    ...
    static auto const& GetSpecializationInfos()
    {
        ...
        { {
            ...
            { Specialization::NecromancerDeathMagic,    "Death Magic",          { { { 0,  820,  857, 1922 }, { 0,  858,  860,  855 }, { 0,  842, 1940, 1694 } } }, Profession::Necromancer,      80 },
            { Specialization::RevenantInvocation,       "Invocation",           { { { 0, 1732, 1761, 1784 }, { 0, 1774, 1760, 1781 }, { 0, 1749, 1791, 1719 } } }, Profession::Revenant,         37 },
            { Specialization::WarriorStrength,          "Strength",             { { { 0, 1447, 1451, 1444 }, { 0, 2000, 1338, 1449 }, { 0, 1437, 1454, 1440 } } }, Profession::Warrior,          27 },
            { Specialization::RangerDruid,              "Druid",                { { { 0, 1868, 2016, 1935 }, { 0, 2053, 2001, 2056 }, { 0, 2057, 2058, 2055 } } }, Profession::Ranger,           53, true },
            { Specialization::EngineerExplosives,       "Explosives",           { { { 0,  514,  525, 1882 }, { 0,  482, 1892, 1944 }, { 0, 1541,  505, 1947 } } }, Profession::Engineer,         61 },
            { Specialization::ThiefDaredevil,           "Daredevil",            { { { 0, 1933, 2023, 1949 }, { 0, 1884, 1893, 1975 }, { 0, 1833, 1964, 2047 } } }, Profession::Thief,           106, true },
            { Specialization::RangerMarksmanship,       "Marksmanship",         { { { 0, 1021, 1014,  986 }, { 0, 1001, 1000, 1070 }, { 0,  996, 1015, 1698 } } }, Profession::Ranger,           83 },
            { Specialization::RevenantRetribution,      "Retribution",          { { { 0, 1811, 1728, 1810 }, { 0, 1766, 1782, 1740 }, { 0, 1779, 1770, 1790 } } }, Profession::Revenant,         42 },
            { Specialization::MesmerDomination,         "Domination",           { { { 0,  686,  682,  687 }, { 0,  693,  713,  712 }, { 0,  681,  680, 1688 } } }, Profession::Mesmer,           56 },
            { Specialization::WarriorTactics,           "Tactics",              { { { 0, 1469, 1474, 1471 }, { 0, 1486, 1479, 1482 }, { 0, 1667, 1470, 1711 } } }, Profession::Warrior,          55 },
            { Specialization::RevenantSalvation,        "Salvation",            { { { 0, 1823, 1824, 1822 }, { 0, 1819, 1817, 1818 }, { 0, 1815, 1825, 1820 } } }, Profession::Revenant,         89 },
            { Specialization::GuardianValor,            "Valor",                { { { 0,  588,  581,  633 }, { 0,  580,  584, 1684 }, { 0,  585,  586,  589 } } }, Profession::Guardian,         24 },
            { Specialization::RevenantCorruption,       "Corruption",           { { { 0, 1793, 1789, 1741 }, { 0, 1727, 1726, 1714 }, { 0, 1795, 1720, 1721 } } }, Profession::Revenant,         91 },
            { Specialization::RevenantDevastation,      "Devastation",          { { { 0, 1776, 1767, 1755 }, { 0, 1786, 1765, 1802 }, { 0, 1715, 1800, 1754 } } }, Profession::Revenant,         78 },
            { Specialization::GuardianRadiance,         "Radiance",             { { { 0,  577,  566,  574 }, { 0,  578,  567,  565 }, { 0, 1686,  579, 1683 } } }, Profession::Guardian,        100 },
            { Specialization::ElementalistWater,        "Water",                { { { 0,  348,  363,  360 }, { 0,  364,  358,  349 }, { 0,  362,  361, 2028 } } }, Profession::Elementalist,     39 },
            { Specialization::WarriorBerserker,         "Berserker",            { { { 0, 2049, 2039, 1977 }, { 0, 2011, 2042, 2002 }, { 0, 1928, 2038, 2043 } } }, Profession::Warrior,          62, true },
            { Specialization::NecromancerBloodMagic,    "Blood Magic",          { { { 0,  780,  788, 1876 }, { 0,  789,  799, 1844 }, { 0,  782, 1692,  778 } } }, Profession::Necromancer,      28 },
            { Specialization::ThiefShadowArts,          "Shadow Arts",          { { { 0, 1160, 1293, 1284 }, { 0, 1297, 1130, 1300 }, { 0, 1134, 1135, 1162 } } }, Profession::Thief,           116 },
            { Specialization::EngineerTools,            "Tools",                { { { 0,  532, 1997,  531 }, { 0,  512, 1946, 1832 }, { 0, 1856,  523, 1679 } } }, Profession::Engineer,         32 },
            { Specialization::WarriorDefense,           "Defense",              { { { 0, 1376, 1488, 1372 }, { 0, 1368, 1379, 1367 }, { 0, 1375, 1649, 1708 } } }, Profession::Warrior,         109 },
            { Specialization::MesmerInspiration,        "Inspiration",          { { { 0,  756,  738,  744 }, { 0,  751,  740, 1980 }, { 0, 2005, 1866,  752 } } }, Profession::Mesmer,          112 },
            { Specialization::MesmerIllusions,          "Illusions",            { { { 0,  721, 1869,  691 }, { 0,  722,  729, 1690 }, { 0,  733, 2035,  753 } } }, Profession::Mesmer,           81 },
            { Specialization::RangerNatureMagic,        "Nature Magic",         { { { 0, 1062,  978, 1060 }, { 0, 1054,  965,  964 }, { 0, 1038, 1988, 1697 } } }, Profession::Ranger,          101 },
            { Specialization::ElementalistEarth,        "Earth",                { { { 0,  282, 1507,  289 }, { 0,  275,  281,  277 }, { 0, 1508,  287, 1674 } } }, Profession::Elementalist,     36 },
            { Specialization::GuardianDragonhunter,     "Dragonhunter",         { { { 0, 1898, 1983, 1911 }, { 0, 2037, 1835, 1943 }, { 0, 1908, 1963, 1955 } } }, Profession::Guardian,         85, true },
            { Specialization::ThiefDeadlyArts,          "Deadly Arts",          { { { 0, 1245, 1276, 1164 }, { 0, 1169, 1292, 1704 }, { 0, 1291, 1167, 1269 } } }, Profession::Thief,            59 },
            { Specialization::EngineerAlchemy,          "Alchemy",              { { { 0,  396,  509,  521 }, { 0,  520,  469,  470 }, { 0,  473, 1871, 1854 } } }, Profession::Engineer,         94 },
            { Specialization::RangerSkirmishing,        "Skirmishing",          { { { 0, 1069, 1067, 1075 }, { 0, 1016, 1700, 1846 }, { 0, 1064, 1912, 1888 } } }, Profession::Ranger,          105 },
            { Specialization::ElementalistFire,         "Fire",                 { { { 0,  296,  328,  335 }, { 0,  325,  340,  334 }, { 0, 1510,  294, 1675 } } }, Profession::Elementalist,     34 },
            { Specialization::RangerBeastmastery,       "Beastmastery",         { { { 0, 1861, 1072, 1606 }, { 0,  975, 1047,  970 }, { 0, 1945,  968, 1066 } } }, Profession::Ranger,           46 },
            { Specialization::RangerWildernessSurvival, "Wilderness Survival",  { { { 0, 1098, 1086, 1099 }, { 0, 1101, 2032, 1100 }, { 0, 1094, 1699, 1701 } } }, Profession::Ranger,           65 },
            { Specialization::NecromancerReaper,        "Reaper",               { { { 0, 1974, 2020, 2026 }, { 0, 1969, 2008, 2031 }, { 0, 1932, 1919, 2021 } } }, Profession::Necromancer,     108, true },
            { Specialization::ThiefCriticalStrikes,     "Critical Strikes",     { { { 0, 1209, 1267, 1268 }, { 0, 1170, 1272, 1299 }, { 0, 1904, 1215, 1702 } } }, Profession::Thief,            54 },
            { Specialization::WarriorArms,              "Arms",                 { { { 0, 1455, 1344, 1334 }, { 0, 1315, 1316, 1333 }, { 0, 1336, 1346, 1707 } } }, Profession::Warrior,          87 },
            { Specialization::ElementalistArcane,       "Arcane",               { { { 0,  253,  266, 1487 }, { 0,  265, 1673,  257 }, { 0,  238,  263, 1511 } } }, Profession::Elementalist,     93 },
            { Specialization::EngineerFirearms,         "Firearms",             { { { 0, 1878, 1930, 1914 }, { 0, 1984, 2006, 1923 }, { 0,  510,  526,  433 } } }, Profession::Engineer,         66 },
            { Specialization::NecromancerCurses,        "Curses",               { { { 0, 1883, 2013,  815 }, { 0,  816, 1693,  812 }, { 0,  813, 1696,  801 } } }, Profession::Necromancer,      22 },
            { Specialization::MesmerChronomancer,       "Chronomancer",         { { { 0, 1838, 1995, 1987 }, { 0, 2009, 1913, 1978 }, { 0, 1942, 2022, 1890 } } }, Profession::Mesmer,           68, true },
            { Specialization::ElementalistAir,          "Air",                  { { { 0,  227,  224,  232 }, { 0,  229,  214, 1502 }, { 0,  226, 1503, 1672 } } }, Profession::Elementalist,     69 },
            { Specialization::GuardianZeal,             "Zeal",                 { { { 0,  563,  634, 1925 }, { 0,  628,  653, 1556 }, { 0,  635,  637, 2017 } } }, Profession::Guardian,        103 },
            { Specialization::EngineerScrapper,         "Scrapper",             { { { 0, 1917, 1971, 1867 }, { 0, 1954, 1999, 1860 }, { 0, 1981, 2052, 1849 } } }, Profession::Engineer,        113, true },
            { Specialization::ThiefTrickery,            "Trickery",             { { { 0, 1159, 1252, 1163 }, { 0, 1277, 1286, 1190 }, { 0, 1187, 1158, 1706 } } }, Profession::Thief,            67 },
            { Specialization::MesmerChaos,              "Chaos",                { { { 0,  670,  675,  677 }, { 0,  673,  668,  669 }, { 0,  671,  674, 1687 } } }, Profession::Mesmer,           47 },
            { Specialization::GuardianVirtues,          "Virtues",              { { { 0,  624,  625,  617 }, { 0,  603,  610,  587 }, { 0,  622,  554,  612 } } }, Profession::Guardian,         30 },
            { Specialization::EngineerInventions,       "Inventions",           { { { 0,  394, 1901,  507 }, { 0, 1678, 1834,  445 }, { 0,  472, 1680, 1916 } } }, Profession::Engineer,         51 },
            { Specialization::ElementalistTempest,      "Tempest",              { { { 0, 1952, 1962, 1886 }, { 0, 1891, 1902, 2015 }, { 0, 1839, 2033, 1986 } } }, Profession::Elementalist,     31, true },
            { Specialization::GuardianHonor,            "Honor",                { { { 0, 1899,  559,  654 }, { 0,  557,  549,  562 }, { 0,  553,  558, 1682 } } }, Profession::Guardian,         45 },
            { Specialization::NecromancerSoulReaping,   "Soul Reaping",         { { { 0,  875,  898,  888 }, { 0,  894,  861,  892 }, { 0,  889,  893,  905 } } }, Profession::Necromancer,      57 },
            { Specialization::WarriorDiscipline,        "Discipline",           { { { 0, 1329, 1413, 1381 }, { 0, 1484, 1489, 1709 }, { 0, 1369, 1317, 1657 } } }, Profession::Warrior,          63 },
            { Specialization::RevenantHerald,           "Herald",               { { { 0, 1813, 1806, 1716 }, { 0, 1738, 1743, 1730 }, { 0, 1746, 1772, 1803 } } }, Profession::Revenant,         84, true },
            { Specialization::NecromancerSpite,         "Spite",                { { { 0,  914,  916, 1863 }, { 0,  899,  829,  909 }, { 0,  919,  853,  903 } } }, Profession::Necromancer,      44 },
            { Specialization::ThiefAcrobatics,          "Acrobatics",           { { { 0, 1112, 1289, 1237 }, { 0, 1241, 1192, 1290 }, { 0, 1238, 1295, 1703 } } }, Profession::Thief,            43 },
            { Specialization::RangerSoulbeast,          "Soulbeast",            { { { 0, 2134, 2071, 2072 }, { 0, 2119, 2085, 2161 }, { 0, 2155, 2128, 2143 } } }, Profession::Ranger,          407, true },
            { Specialization::ElementalistWeaver,       "Weaver",               { { { 0, 2177, 2165, 2115 }, { 0, 2180, 2061, 2170 }, { 0, 2131, 2090, 2138 } } }, Profession::Elementalist,    416, true },
            { Specialization::EngineerHolosmith,        "Holosmith",            { { { 0, 2114, 2157, 2106 }, { 0, 2103, 2152, 2091 }, { 0, 2066, 2137, 2064 } } }, Profession::Engineer,        409, true },
            { Specialization::ThiefDeadeye,             "Deadeye",              { { { 0, 2145, 2173, 2136 }, { 0, 2118, 2078, 2160 }, { 0, 2111, 2093, 2146 } } }, Profession::Thief,           404, true },
            { Specialization::MesmerMirage,             "Mirage",               { { { 0, 2141, 2082, 2110 }, { 0, 2178, 2174, 2098 }, { 0, 2070, 2113, 2169 } } }, Profession::Mesmer,          405, true },
            { Specialization::NecromancerScourge,       "Scourge",              { { { 0, 2167, 2074, 2102 }, { 0, 2059, 2067, 2123 }, { 0, 2112, 2164, 2080 } } }, Profession::Necromancer,     412, true },
            { Specialization::WarriorSpellbreaker,      "Spellbreaker",         { { { 0, 2107, 2153, 2140 }, { 0, 2126, 2097, 2095 }, { 0, 2163, 2168, 2060 } } }, Profession::Warrior,         415, true },
            { Specialization::GuardianFirebrand,        "Firebrand",            { { { 0, 2075, 2101, 2086 }, { 0, 2063, 2076, 2116 }, { 0, 2105, 2179, 2159 } } }, Profession::Guardian,        417, true },
            { Specialization::RevenantRenegade,         "Renegade",             { { { 0, 2166, 2079, 2120 }, { 0, 2133, 2092, 2108 }, { 0, 2094, 2100, 2182 } } }, Profession::Revenant,        410, true },
            { Specialization::NecromancerHarbinger,     "Harbinger",            { { { 0, 2188, 2219, 2185 }, { 0, 2192, 2220, 2209 }, { 0, 2218, 2194, 2203 } } }, Profession::Necromancer,     465, true },
            { Specialization::GuardianWillbender,       "Willbender",           { { { 0, 2191, 2190, 2187 }, { 0, 2197, 2210, 2199 }, { 0, 2195, 2201, 2198 } } }, Profession::Guardian,        466, true },
            { Specialization::MesmerVirtuoso,           "Virtuoso",             { { { 0, 2212, 2208, 2202 }, { 0, 2215, 2205, 2207 }, { 0, 2211, 2206, 2223 } } }, Profession::Mesmer,          464, true },
            { Specialization::ElementalistCatalyst,     "Catalyst",             { { { 0, 2230, 2252, 2224 }, { 0, 2247, 2249, 2234 }, { 0, 2233, 2241, 2251 } } }, Profession::Elementalist,    467, true },
            { Specialization::WarriorBladesworn,        "Bladesworn",           { { { 0, 2237, 2260, 2225 }, { 0, 2253, 2244, 2240 }, { 0, 2261, 2239, 2245 } } }, Profession::Warrior,         468, true },
            { Specialization::RevenantVindicator,       "Vindicator",           { { { 0, 2258, 2248, 2228 }, { 0, 2259, 2243, 2255 }, { 0, 2257, 2232, 2238 } } }, Profession::Revenant,        469, true },
